  ...
  return (
    <div className="services-page">
        ...
        <div className="mid-text">
          <p>
          At <span>GAMMA SPECTRE</span>, we pride ourselves on delivering exceptional services tailored to meet your needs. Our team is dedicated to providing top-notch solutions that exceed your expectations and help you achieve your goals. Whether you're a small startup or a large corporation, we have the expertise and resources to support you every step of the way.
          </p>
        </div>
