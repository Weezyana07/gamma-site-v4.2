    ...
    <div className="about-container">
      ...
      <section className="mission-vision">
        <div className="mission">
          <h2>Our Mission</h2>
          <p>
            Deliver exceptional solutions and services that enable progress,
            improve communities, and drive innovation.
          </p>
        </div>
        <div className="vision">
          <h2>Our Vision</h2>
          <p>
            Be a dynamic and versatile leader known for driving economic growth
