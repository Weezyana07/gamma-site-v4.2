  ...
  return (
    <>
      ...
      >
        ...
        <div
          className="relative w-full h-[70vh] bg-cover bg-center flex flex-col justify-center pl-16"
          style={{
        ...
        {/* 30vh Section for Paragraph (Outside Overlay) */}
        <div className="relative h-[30vh] flex items-center text-center px-16">
