          ...
          <div className="">
            <div className="section2-first">
              <Card1
                ...
                header="Consultancy"
                text="We offer specialised consultancy services to a wide range of industries, providing expert guidance and solutions for diverse challenges."
                button="READ MORE"
              />
              <Card1
                image="/images/information.png"
                header="Information Technology"
                text="Our IT division excels in delivering cutting-edge technology solutions, including network infrastructure, software development, and telecom services."
                button="READ MORE"
              />
              <Card1
                image="/images/manufacturing.png"
                header="Manufacturing"
                text="Our construction division is dedicated to the creation of quality infrastructures, from residential and commercial buildings to civil engineering projects."
                button="READ MORE"
              />
            </div>
