      ...
      <section className="mission-vision">
        <div className="mission-vision-section">
          ...
          <div>
            ...
            <h1>Vision</h1>
            <p>
              Our vision at <strong className="highlight">Gamma Spectre</strong>{" "}
              is to be a dynamic and versatile leader in the business world,
              known for our ability to adapt and excel in a variety of sectors.
              We aspire to provide innovative solutions that drive economic
              growth, enhance technological capabilities, and foster sustainable
              development.
            </p>
          </div>
        </div>
